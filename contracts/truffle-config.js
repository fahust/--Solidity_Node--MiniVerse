...
module.exports = {
  networks: {
    ...
    rinkeby: {
      provider: function () {
        return new HDWalletProvider(
          ...
          `https://rinkeby.infura.io/v3/`+process.env.INFURA_PROJECT_RINKEBY_ID
        );
      },
      network_id: 4,
      gas: 4500000,
    ...
    matic: {
      provider: () => new HDWalletProvider(process.env.INFURA_MNEMONIC, `https://polygon-mainnet.infura.io/v3/`+process.env.INFURA_APIKEY_MATIC),
      network_id: 137,
      gasPrice: 100000000000
    },
    mumbai: {
      provider: () => new HDWalletProvider(process.env.INFURA_MNEMONIC, `https://polygon-mumbai.infura.io/v3/`+process.env.INFURA_APIKEY_MUMBAI),
      network_id: 80001,
      confirmations: 2,
      timeoutBlocks: 200,
      skipDryRun: true

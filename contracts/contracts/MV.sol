...
contract MV is ERC20, Ownable {
  ...
  ///@notice Function to offer MV tokens to a wallet address
  function mint(address to, uint256 value) external byDelegate {
    require(totalSupply() < maxSupply, "Max supply reached");
    _mint(to, value);
  }

  ///@notice Function to destroy MV tokens to a wallet address
  ...
  function _beforeTokenTransfer(
    ...
    require(block.timestamp >= pausedTransferEndDate || from == address(0), "transfer is paused");
